                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="/admin/guru/daftar_guru">
                                <div class="sb-nav-link-icon"><i class="fas fa-graduation-cap"></i></div>
                                Daftar Guru
                            </a>
                            <a class="nav-link" href="/admin/guru/daftar_jadwal">
                                <div class="sb-nav-link-icon"><i class="fas fa-calendar"></i></div>
                                Daftar Jadwal
                            </a>
                            <a class="nav-link" href="/admin/guru/daftar_siswa">
                                <div class="sb-nav-link-icon"><i class="fas fa-database"></i></div>
                                Daftar Siswa
                            </a>
                            <div class="sb-sidenav-menu-heading">Operational</div>
                            <a class="nav-link" href="/admin/guru/tugas">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Tugas
                            </a>
                            <a class="nav-link" href="/admin/guru/input_nilai_siswa">
